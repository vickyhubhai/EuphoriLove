  ...
  const socialLinks = [
    {
      ...
      url: "https://twitter.com/euphorilove"
    },
    {
      name: "Instagram",
      icon: (
      ...
      url: "https://instagram.com/euphorilove"
    },
    {
      name: "LinkedIn",
      icon: (
      ...
      url: "https://linkedin.com/company/euphorilove"
    }
  ];
    ...
    <div className="flex flex-col h-screen w-screen bg-background background-gradient text-white py-2 relative overflow-hidden" suppressHydrationWarning>
      ...
      <div className="max-w-screen-lg mx-auto w-full px-4 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="glass-effect rounded-xl p-6">
            <h2 className="text-2xl font-semibold gradient-text mb-6">Connect With Us</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-medium mb-2">Location</h3>
                <p className="text-gray-200">Mumbai, Maharashtra, India</p>
              </div>
              <div>
                <h3 className="text-xl font-medium mb-2">Email</h3>
                <a href="mailto:contact@euphorilove.com" className="text-gray-200 hover:text-primary-400 transition-colors">
                  contact@euphorilove.com
                </a>
              </div>
              <div>
